...
def create_change_request(
    ...
    url = f"{server_config.instance_url}/api/now/table/change_request"
...
def update_change_request(
    ...
    # Make the API request
    url = f"{server_config.instance_url}/api/now/table/change_request/{validated_params.change_id}"
...
def add_change_task(
    ...
    # Make the API request
    url = f"{server_config.instance_url}/api/now/table/change_task"
...
def approve_change(
    ...
    approval_query_url = f"{server_config.instance_url}/api/now/table/sysapproval_approver"
